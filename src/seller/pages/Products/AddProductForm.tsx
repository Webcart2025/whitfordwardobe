...
const ProductForm = () => {
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      const sellerId = sellers?.selectedSeller?.id; // Adjust based on your Redux state
      const timestamp = new Date().toISOString(); // Generate timestamp
      dispatch(createProduct({ request: {...values,sellerId,createdAt: timestamp}, jwt: localStorage.getItem("jwt") }))
  ...
  // onSubmit: (values) => {
  //   const sellerId = sellers?.currentSeller?.id; // Adjust based on your Redux state
  //   dispatch(createProduct({
  //     request: { ...values, sellerId }, 
